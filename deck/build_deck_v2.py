"""Build deck_v2.pdf from deck_v2.html (legible conversation + verdict crops).
Leaves the v1 deck.pdf untouched. Also writes per-slide PNGs to deck/preview_v2/
and reports any slide that overflows 1280x720.

Run:  uv run --with playwright python deck/build_deck_v2.py
"""
import re
...
html = (HERE / "deck_v2.html").read_text(encoding="utf-8").replace("<!--LOGO_LIGHT-->", svg_light)
built = HERE / "deck_v2_built.html"
built.write_text(html, encoding="utf-8")

prev = HERE / "preview_v2"
...
with sync_playwright() as p:
    ...
    pg.pdf(path=str(HERE / "deck_v2.pdf"), width="1280px", height="720px",
           print_background=True, margin={"top": "0", "bottom": "0", "left": "0", "right": "0"})
    b.close()

print(f"deck_v2.pdf + {n} preview PNGs -> {HERE}")
