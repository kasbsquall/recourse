"""Build deck_v4.pdf from deck_v4.html (6 agents, dynamic recruitment, 3-case demo, evidence,
signed record + JSON). Writes per-slide PNGs to deck/preview_v4/ and flags any slide that
overflows 1280x720.

Run:  uv run --with playwright python deck/build_deck_v4.py
"""
import re
...
html = (HERE / "deck_v4.html").read_text(encoding="utf-8").replace("<!--LOGO_LIGHT-->", svg_light)
built = HERE / "deck_v4_built.html"
built.write_text(html, encoding="utf-8")

prev = HERE / "preview_v4"
...
with sync_playwright() as p:
    ...
    pg.pdf(path=str(HERE / "deck_v4.pdf"), width="1280px", height="720px",
           print_background=True, margin={"top": "0", "bottom": "0", "left": "0", "right": "0"})
    b.close()

print(f"deck_v4.pdf + {n} preview PNGs -> {HERE}")
